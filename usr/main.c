...
int main(void)
{
	int fd = wiringPiSPISetup(0, 3000000); //3MHz
	if (fd < 0) {
	...
	* For initialisation, DW1000 clocks must be temporarily set to crystal speed. After initialisation SPI rate can 
	* be increased for optimum performance. */
